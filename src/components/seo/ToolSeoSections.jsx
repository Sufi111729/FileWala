      ...
      {relatedTools.length > 0 && (
        <section className="mt-10">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-wide text-black/60">{text.sections.relatedTools}</p>
              <h2 className="mt-1 text-2xl font-black text-black">{tLiteral('More useful FileWalaTool options')}</h2>
            </div>
