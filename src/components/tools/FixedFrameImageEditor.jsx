    ...
    <div className="grid gap-5 pb-24 lg:grid-cols-[minmax(0,1fr)_300px] lg:pb-0">
      ...
      <aside className="grid content-start gap-4">
        ...
        <div className="rounded-md border border-black/10 bg-white p-4 shadow-sm">
          ...
          {result?.blob && (
            <div className="mt-4">
              <ToolResultCard title={text.documentTool.previewReady} fileName={activeFilename} fileSize={formatFileSize(result.blob.size)} />
            </div>
          )}
          <button
            type="button"
      ...
      <StickyActionBar
        primaryLabel={text.common.preview}
        ...
        onDownload={() => canDownload && downloadBlob(result.blob, activeFilename)}
